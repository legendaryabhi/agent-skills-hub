...
**Using npx:** `npx agent-skills-hub` (or `npx github:sickn33/agent-skills-hub` if you get a 404).
...
```bash
git clone -c core.symlinks=true https://github.com/sickn33/agent-skills-hub.git .agent/skills
```
...
Please [Open an issue](https://github.com/sickn33/agent-skills-hub/issues)!
Include:
...
**Still confused?** [Open a discussion](https://github.com/sickn33/agent-skills-hub/discussions) and we'll help you out! 🙌
